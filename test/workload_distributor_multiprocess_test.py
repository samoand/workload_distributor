...
@run_distributively('text', text_mapper, total_reducer)
def count_num_words(text):
    return count_words(text)

@run_distributively('text', None, total_reducer)
...
@run_distributively('sum_me_up', num_mapper, total_reducer)
...
class UtilTestCase(UnitTestCase):
    ...
    def test_count_sum(self):
        # verify that sum([1..1000]) is equal to
